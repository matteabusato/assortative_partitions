...
class Factorial():
    ...
    def get_factorial_chi(self, r, k):
        return self.factorials[r-self.H+1][k] * (self.D-r-k) / self.D
    
    def get_factorial_Z_node(self, r, k):
        return self.factorials[r-self.H+1][k]
...
if __name__ == "__main__":
    ...
    if experiment == "FIGURE7":
        ...
        # Hs = [[1, 2], [1, 2, 3], [1, 2, 3, 4], [2, 3, 4, 5], [2, 3, 4, 5], [3, 4, 5, 6], [3, 4, 5, 6], [3, 4, 5, 6], [4, 5, 6, 7], [4, 5, 6, 7, 8]]
        Ds = [11]
        Hs = [[4, 5, 6], [3, 4, 5]]
        ...
        initialization_chi = "almost_unif"
        N_RUNS = 10
    elif experiment == "HEATMAP_FIGURE5A":
        Ds = [7]
        Hs = [[4]]
        Ms = []
        ...
        THRESHOLD = 1e-10
        MAX_ITER = 5000000
    elif experiment == "FIXEDM1_FIGURE5A_2":
        # M1 = 0.05, 0.2, 1/3
        Ds = [7]
        Hs = [[5]]
        Ms = []
    ...
    for i, D in enumerate(Ds):
        for H in Hs[i]:
            ...
            for M in Ms:
                ...
                if SAVE_IN_CSV:
                    file_path = f"results_experiments/3ASS_{experiment}/results_job.csv"
