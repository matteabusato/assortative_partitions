...
CONFIGS: List[Dict[str, Any]] = [
    ...
    # {"d": 13, "H": 7, "expected_phase": "unclear"},
    ...
    # {"d": 14, "H": 6, "expected_phase": "unclear"},
    # {"d": 14, "H": 7, "expected_phase": "unclear"},
    ...
    # {"d": 15, "H": 6, "expected_phase": "unclear"},
    # {"d": 15, "H": 7, "expected_phase": "unclear"},
    # {"d": 15, "H": 8, "expected_phase": "unclear"},
    ...
    # {"d": 16, "H": 8, "expected_phase": "unclear"},
    ...
    # {"d": 17, "H": 8, "expected_phase": "unclear"},
    # {"d": 17, "H": 9, "expected_phase": "unclear"},
    ...
    # {"d": 18, "H": 8, "expected_phase": "unclear"},
    # {"d": 18, "H": 9, "expected_phase": "unclear"},

    # # d = 19
    # {"d": 19, "H": 1, "expected_phase": "easy_RS"},
    # {"d": 19, "H": 2, "expected_phase": "easy_RS"},
    # {"d": 19, "H": 3, "expected_phase": "easy_RS"},
    # {"d": 19, "H": 4, "expected_phase": "easy_RS"},
    # {"d": 19, "H": 5, "expected_phase": "easy_RS"},
    # {"d": 19, "H": 6, "expected_phase": "unclear"},
    # {"d": 19, "H": 7, "expected_phase": "unclear"},
    # {"d": 19, "H": 8, "expected_phase": "unclear"},
    # {"d": 19, "H": 9, "expected_phase": "unclear"},

    # d = 20
    {"d": 20, "H": 1, "expected_phase": "easy_RS"},
    {"d": 20, "H": 2, "expected_phase": "easy_RS"},
    {"d": 20, "H": 3, "expected_phase": "easy_RS"},
    {"d": 20, "H": 4, "expected_phase": "easy_RS"},
    {"d": 20, "H": 5, "expected_phase": "easy_RS"},
    {"d": 20, "H": 6, "expected_phase": "unclear"},
    {"d": 20, "H": 7, "expected_phase": "unclear"},
    {"d": 20, "H": 8, "expected_phase": "unclear"},
    {"d": 20, "H": 9, "expected_phase": "unclear"},
    {"d": 20, "H": 10, "expected_phase": "unclear"},
]
...
def main() -> None:
    ...
    output_root = Path(
        os.environ.get(
            "PD_OUTPUT_DIR",
            str(PROJECT_ROOT / "results" / "k3_assortative_full_sweep"),
        )
    )

    run_name = (
        f"K3_assortative_d{d}_H{H}_{expected_phase}"
    ...
    pd = PopDyn(
        ...
        wandb_group="K3_assortative_full_sweep",
        wandb_name=run_name,
        wandb_config_extra={
            "config_index": config_index,
            "expected_phase": expected_phase,
            "sweep_name": "K3_assortative_full_sweep",
        },
        log_every=200,
