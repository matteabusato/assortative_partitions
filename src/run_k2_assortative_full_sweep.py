...
CONFIGS: List[Dict[str, Any]] = [
    ...
    # {"d": 14, "H": 8, "expected_phase": "frozen_1RSB"},
    # {"d": 14, "H": 9, "expected_phase": "UNSAT"},
    ...
    # {"d": 16, "H": 9, "expected_phase": "frozen_1RSB"},
    ...
    # {"d": 17, "H": 10, "expected_phase": "UNSAT"},
    ...
    # {"d": 18, "H": 10, "expected_phase": "frozen_1RSB"},
    ...
    {"d": 19, "H": 11, "expected_phase": "UNSAT"}
    ...
    # {"d": 20, "H": 11, "expected_phase": "frozen_1RSB"}
