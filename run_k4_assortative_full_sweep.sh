...
mkdir -p job_output
mkdir -p results/k4_assortative_full_sweep
...
export PD_OUTPUT_DIR="${PD_OUTPUT_DIR:-${PROJECT_ROOT}/results/k4_assortative_full_sweep}"
...
srun --cpu-bind=cores \
    python -u src/run_k4_assortative_full_sweep.py
